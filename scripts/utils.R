...
FolderRoot = ""
if (sistema[1] == "Linux"){
  FolderRoot = paste("/home/", sistema[7], "/Generate-Partitions-Jaccard", sep="")
} else {
  FolderRoot = paste("C:/Users/", sistema[7], "/Generate-Partitions-Jaccard", sep="")
}
...
directories <- function(dataset_name, folderResults){
  ...
  #############################################################################
  folderResultsJaccard = paste(folderResultsDataset, "/Jaccard", sep="")
  if(dir.exists(folderResultsJaccard) == TRUE){
    setwd(folderResultsJaccard)
    dir_folderResultsJaccard = dir(folderResultsJaccard)
    n_folderResultsJaccard = length(dir_folderResultsJaccard)
  } else {
    dir.create(folderResultsJaccard)
    setwd(folderResultsJaccard)
    dir_folderResultsJaccard = dir(folderResultsJaccard)
    n_folderResultsJaccard = length(dir_folderResultsJaccard)
  }
  ...
  retorno$folderResultsJaccard = folderResultsJaccard
  ...
  retorno$dir_folderResultsJaccard = dir_folderResultsJaccard
  ...
  retorno$n_folderResultsJaccard = n_folderResultsJaccard
