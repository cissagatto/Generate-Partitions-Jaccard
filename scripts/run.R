...
##################################################################################################
executeGPJ <- function(number_dataset, number_cores, number_folds, folderResults){
  ...
  cat("\n##################################################################################################")   
  cat("\n#Run: Compute Jaccard                                                                            #")
  timeCJ = system.time(resCJ <- computeJaccard(ds, dataset_name, number_folds, namesLabels, resLS, folderResults))
  cat("\n##################################################################################################\n\n") 
  
  cat("\n##################################################################################################")   
  cat("\n#Run: Get partitions Jaccard                                                                     #")
  timeCT = system.time(resCT <- CutreeHClust(ds, dataset_name, number_folds, namesLabels, resLS, folderResults))
  cat("\n##################################################################################################\n\n") 
