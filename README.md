...
## RUN
To run the code, open the terminal, enter the *~/Generate-Partitions-Jaccard/R* folder, and type

```
Rscript jaccard.R [absolute_path_to_config_file]
```

Example:

```
Rscript jaccard.R "~/Generate-Partitions-Jaccard/GPJ-Config-Files/GPJ-GpositiveGO.csv"
```
...
## DOWNLOAD RESULTS
[Click here](https://www.4shared.com/folder/fwM4omvr/Jaccard.html)
