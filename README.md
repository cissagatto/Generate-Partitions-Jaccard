# Generate Random Partitions Jaccard
...
## Results
The results stored in the folder _OUTPUT_ it will be used in the next phase: Best-Partition-Silhoute or Best-Partition-Clus. The result for a dataset must be put in the folder _PARTITIONS_ in the code (https://github.com/cissagatto/Best-Partition-Silhouete)
