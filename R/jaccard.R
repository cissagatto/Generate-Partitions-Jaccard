...
#config_file = "/home/cissa/Generate-Partitions-Jaccard/GPJ-Config-Files/GPJ-emotions.csv"
...
# cat("\n####################################################################\n\n")
# destino = paste("nuvem:Partitions-Jaccard/", dataset_name, sep="")
# oriem = paste(diretorios$folderResults, "/", dataset_name, sep="")
